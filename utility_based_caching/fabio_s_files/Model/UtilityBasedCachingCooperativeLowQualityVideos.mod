...
// Versione cooperativa con low quality videos
...
subject to {
	...
	forall ( r in ObjRequests, lqv in LowQualityVideos : lqv == r.object, q in QualityLevels : q != 1 )
	ctLowQualityVideos:
		ObjectRequestsServed[r][q] == 0;
}
