...
%{ TOPOLOGY
	...
	if ( strcmp(data.topofile,"") )
		...
		data.topology_size = 11;
		data.edge_nodess = [6]; % How many edge nodes
		...
		data.server_positions = {"edges"}; %"complement_to_edges", "edges" or "specific"
...
data.strategys = {"AlwaysLowQuality", "PropDedCache"};
