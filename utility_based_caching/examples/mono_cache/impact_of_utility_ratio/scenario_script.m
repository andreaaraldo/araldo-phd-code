...
experiment_name = "impact_of_utility_ratio";
ases = [1, 2];
...
utility_ratio = 8; % Ratio between low and high quality utility
utility_when_not_serving = 0;
ASes_with_users = [1];
server = 2;
load_ = 1;
total_requests = 2800 * load_;
...
single_value_folder = sprintf("%s/utility_ratio_%g", experiment_folder, utility_ratio);
