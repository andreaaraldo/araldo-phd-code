function [hist_allocation, hist_cum_tot_requests, hist_cum_hit] =...
	...
	hist_cum_num_of_misses(:,1) = [];

	hist_cum_tot_requests = zeros(1,settings.epochs+1); 
	for t=1:settings.epochs; 
		hist_cum_tot_requests(:,t+1) = hist_cum_tot_requests(:,t) + hist_tot_requests(:,t); 
	endfor;
	hist_cum_tot_requests(:,1) = [];

	
	hist_cum_hit = 1- sum(hist_cum_num_of_misses,1) ./ hist_cum_tot_requests; 
